...
public class Book_Appointment_Page extends BaseTestMethod {
...
Thread.sleep(2000);
	...
	@FindBy(xpath = "(//button[@class='btn btn-link book'])[1]")
	...
	("//button[@class='btn btn-link book']"));
   int value =	elements1.size();
   driver.findElement(By.xpath("(//button[@class='btn btn-link book'])["+value+"]")).click();
	boolean Appointment_Popup= New_Appointment_Popup.isDisplayed();
	validateResults(Appointment_Popup, true);

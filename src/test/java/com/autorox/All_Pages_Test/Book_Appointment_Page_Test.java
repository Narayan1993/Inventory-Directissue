...
public class Book_Appointment_Page_Test extends All_Page_Intializer {
	 ...
	 * 
	 * @Test(priority = 1) public void BookAppointmentPageLabelsValidation() throws
	 * Throwable { LoginPageTest().Valid_Login("janae.marquardt", "3K#Bi&%9");
	 * Book_Appointment().AllLabelsVerification();
	 * Book_Appointment().NAallLabelsValidationClickOnCalender(); }
	 * 
	 * // All date and time validations
	 * 
	 * @Test(priority = 2) public void BookAppointmentPageTimeValidation() throws
	 * Throwable { refresh(); Book_Appointment().PastDatePastTimeValiadtionInBP();
	 * Book_Appointment().PresentDatePastTimeValiadtionInBP(); refresh();
	 * Book_Appointment().PresentDateCurrentTimeValiadtionInBP();
	 * Book_Appointment().PresentDatePastTimeValiadtionInBP(); refresh();
	 * Thread.sleep(2000); Book_Appointment().futureDateCurrentTimeValiadtionInBP();
	 * 
	 * }
	 * 
	 ...
	 * @Test(priority=3)
	 * 
	 * public void BookAppointmentPageNPCreationAndLabelValidation() throws
	 * Throwable {
	 * 
	 * Book_Appointment().NPBookingClickOnAddNewIndividual();
	 * Book_Appointment().NPBookingClickOnCalenderIndividual(); beforeMethod();
	 ...
	 * BookAppointment_through_jobcardCreation_Test() throws Throwable {
	 * beforeMethod(); LoginPageTest().Valid_Login("nannie.braun", "zv#66P%t");
	 * Book_Appointment().Appointment_creation_MonthToDayView(); refresh();
	...
	public void Duplicate_Appointment_Creation_And_alert_Message_Validation() throws Throwable {
		...
		Book_Appointment().AB_For_Existing_Customer_Through_Search();
	}
}
